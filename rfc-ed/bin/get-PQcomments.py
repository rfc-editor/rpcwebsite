...
"PQ" are then printed to standard out with a numeric heading, #).
...
# produce output
if comments:
    print('Here are the [rfced] comments marked as "PQ" in the XML file.\n')
