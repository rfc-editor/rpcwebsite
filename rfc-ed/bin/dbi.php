...
/**************************************************************************************/
/*Script Name : dbi.php                                                               */
/*Description : Script defines function to connect handle for database                */
/**************************************************************************************/
# Global db variables
$db_connected = 0;
...
//  error_log("close_db enter: \$db_connected=$db_connected");
  if ( ! --$db_connected ) mysqli_close($db_handle);
//  error_log("close_db exit: \$db_connected=$db_connected");
}
