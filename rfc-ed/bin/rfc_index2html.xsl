...
<!-- $Id: rfc_index2html.xsl,v 2.8 2024/08/13 20:29:01 priyanka Exp $ -->
...
<!-- 
This template drives the processing. RFC documents are sorted in ascending
order.
-->
  ...
  <html>
    ...
    <body>
      ...
      <p>
        This file contains citations for all RFCs in numeric order. RFC citations appear in this format:
      </p>
      <table border="5">
        <tr>
          <td> Num </td>
